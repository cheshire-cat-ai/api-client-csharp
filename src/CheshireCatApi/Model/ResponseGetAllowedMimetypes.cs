...
namespace CheshireCatApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Response_Get_Allowed_Mimetypes")]
    public partial class ResponseGetAllowedMimetypes : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseGetAllowedMimetypes" /> class.
        /// </summary>
        /// <param name="allowed">allowed.</param>
        public ResponseGetAllowedMimetypes(List<string> allowed = default(List<string>))
        {
