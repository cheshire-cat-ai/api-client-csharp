...
namespace CheshireCatApi.Model
{
    ...
    public partial class Collection : IValidatableObject
    {
        ...
        /// <param name="vectorsCount">vectorsCount (required).</param>
        public Collection(string name = default(string), int vectorsCount = default(int))
        {
        ...
        /// <summary>
        /// Gets or Sets VectorsCount
        /// </summary>
        [DataMember(Name = "vectors_count", IsRequired = true, EmitDefaultValue = true)]
