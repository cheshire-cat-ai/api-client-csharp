...
namespace CheshireCatApi.Model
{
    ...
    /// CollectionsList
    /// </summary>
    [DataContract(Name = "CollectionsList")]
    public partial class CollectionsList : IValidatableObject
    {
        /// <summary>
        ...
        public CollectionsList(List<Collection> collections = default(List<Collection>))
        {
            // to ensure "collections" is required (not null)
            if (collections == null)
            {
                throw new ArgumentNullException("collections is a required property for CollectionsList and cannot be null");
            }
